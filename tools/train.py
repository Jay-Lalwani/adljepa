...
def main():
    ...
    if args.pretrained_model is not None and 'ad_l_jepa' in args.pretrained_model:
         # As JEPA architecture includes encoder, target_encoder and predictor, load encoder only from JEPA
        model.load_ad_l_jepa_params_from_file(filename=args.pretrained_model, to_cpu=dist_train, logger=logger)
